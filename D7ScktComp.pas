...
begin
  Result := SendBuf(Pointer(AnsiString(S))^, Length(AnsiString(S)));
end;
...
var
  sResult:AnsiString;
begin
  SetLength(sResult, ReceiveBuf(PAnsiChar(nil)^, -1));
  SetLength(sResult, ReceiveBuf(PAnsiChar(sResult)^, Length(sResult)));
