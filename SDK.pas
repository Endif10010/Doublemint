...
{  TPath = array of TPoint; //路径数组
  ...
  TFindProc = function(ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Pointer; stdcall;
  TSetProc = function(ProcAddr: Pointer; ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Boolean; stdcall;
  TFindObj = function(ObjName: PAnsiChar; nNameLen: Integer; nObjcCode: Integer): TObject; stdcall;
  ...
  TStartRegister = function(sRegisterInfo: PAnsiChar): Boolean; stdcall;
  TGetStrProc = procedure(sRegisterCode: PAnsiChar); stdcall;
  TGameDataLog = function(ProcName: PAnsiChar; nNameLen: Integer): Boolean; stdcall;
  TIPLocal = procedure(sIPaddr: PAnsiChar; sLocal: PAnsiChar; nLocalLen: Integer); stdcall;
  TDeCryptString = procedure(Src, Dest: PAnsiChar; nSrc: Integer); stdcall;

  TGetFunAddr = function(nIndex: Integer; nComputeCode: Int64): Pointer; stdcall;
  TGetRegister = function(SerialNumber, UserName: PAnsiChar; Version: Integer; UserLicense: Int64): Boolean; stdcall;

  TChangeCaptionText = procedure(Msg: PAnsiChar; nLen: Integer); stdcall;
  TChangeGateSocket = procedure(boOpenGateSocket: Boolean); stdcall;
  TSetMaxPlayObjectCount = procedure(Buffer: PAnsiChar; nLen: Integer); stdcall;
  ...
  TObjectActionXYDWS = procedure(AObject, BObject: TObject; wIdent: Word; nX, nY: Integer; btDir: Byte; pszMsg: PAnsiChar); stdcall;
  TObjectActionObject = procedure(AObject, BObject, CObject: TObject; nInt: Integer); stdcall;
  TObjectActionDetailGoods = procedure(Merchant: TObject; PlayObject: TObject; pszItemName: PAnsiChar; nInt: Integer); stdcall;
  TObjectActionUserSelect = procedure(Merchant: TObject; PlayObject: TObject; pszLabel, pszData: PAnsiChar); stdcall;
  TObjectUserCmd = function(AObject: TObject; pszCmd, pszParam1, pszParam2, pszParam3, pszParam4, pszParam5, pszParam6, pszParam7: PAnsiChar): Boolean; stdcall;
  TPlaySendSocket = function(AObject: TObject; DefMsg: pTDefaultMessage; pszMsg: PAnsiChar): Boolean; stdcall;
  TObjectActionItem = function(AObject: TObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
  TObjectClientMsg = function(PlayObject: TObject; DefMsg: pTDefaultMessage; Buff: PAnsiChar; NewBuff: PAnsiChar): Integer; stdcall;
  TObjectActionFeature = function(AObject, BObject: TObject): Integer; stdcall;
  TObjectActionSendGoods = procedure(AObject: TObject; nNpcRecog, nCount, nPostion: Integer; pszData: PAnsiChar); stdcall;
  ...
  TObjectFilterMsg = function(PlayObject: TObject; pszSrcMsg, pszDestMsg: PAnsiChar; var boGotoLabel: Boolean): Boolean; stdcall;
  TEDCode = procedure(pszSource: PAnsiChar; pszDest: PAnsiChar; nSrcLen, nDestLen: Integer); stdcall;
  ...
  TScriptCmd = function(pszCmd: PAnsiChar): Integer; stdcall;
