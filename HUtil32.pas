...
{*}
function ArrestStringEx(Source: string; SearchAfter, ArrestBefore: string; var ArrestStr: string): string;
function ArrestStringEx2(Source: string; SearchAfter, ArrestBefore: string; var ArrestStr: string): string;
